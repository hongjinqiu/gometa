 ...
 */
Y.RSelectField = Y.Base.create('r-select-field', Y.RChoiceField, [Y.WidgetParent, Y.WidgetChild], {

    FIELD_TEMPLATE : '<select></select>',

    /**
     * @property RSelectField.DEFAULT_OPTION_TEXT
     * @type String
    ...
    _renderFieldNode: function() {
        Y.RSelectField.superclass.constructor.superclass._renderFieldNode.apply(this, arguments);
    ...
    _renderOptionNodes: function() {
        ...
        if (this.get('useDefaultOption') === true) {
            elOption = Y.Node.create(Y.RSelectField.OPTION_TEMPLATE);
    ...
    _syncFieldNode: function() {
        Y.RSelectField.superclass.constructor.superclass._syncFieldNode.apply(this, arguments);
    ...
    bindUI: function() {
        Y.RSelectField.superclass.constructor.superclass.bindUI.apply(this, arguments);
        this.after('choicesChange', this._afterChoicesChange);
    },

    syncUI: function() {
        Y.RSelectField.superclass.syncUI.apply(this, arguments);
        this._syncOptionNodes();
    }
},
{
    /**
	 * @property RSelectField.OPTION_TEMPLATE
	 * @type String
