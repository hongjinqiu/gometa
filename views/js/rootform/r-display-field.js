...
Y.RDisplayField = Y.Base.create('r-display-field', Y.Widget, [Y.WidgetParent, Y.WidgetChild], {
    toString: function() {
        return this.name;
    },

    /**
     * @property RDisplayField.FIELD_TEMPLATE
     * @type String
    ...
    /**
     * @property RDisplayField.FIELD_CLASS
     * @type String
